...
import com.breezefielddemax.app.utils.AppUtils.Companion.changeAttendanceDateFormatToCurrent
import com.breezefielddemax.app.utils.FTStorageUtils
import com.breezefielddemax.app.utils.NotificationUtils
...
import com.breezefielddemax.features.addshop.model.AssignedToShopListResponseModel
import com.breezefielddemax.features.addshop.model.QuestionSubmit
import com.breezefielddemax.features.addshop.model.UpdateAddrReq
import com.breezefielddemax.features.addshop.model.UpdateAddressShop
...
import com.breezefielddemax.features.addshop.presentation.*
...
import com.breezefielddemax.features.location.model.ShopDurationRequestData
...
import com.breezefielddemax.features.marketing.api.marketingcategorylist.MarketingCatListRepoProvider
import com.breezefielddemax.features.marketing.model.MarketingCategoryListResponse
...
import com.breezefielddemax.features.nearbyshops.model.StageListResponseModel
...
import com.breezefielddemax.features.shopdetail.presentation.AddCollectionDialog
...
import com.breezefielddemax.features.viewAllOrder.interf.QaOnCLick
...
//                            val uri = Uri.fromFile(file)
                ...
                val path = Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS).toString() +"/breezefielddemaxApp/SHOPDtls/"
                var pathNew = ""
                val dir = File(path)
                if (!dir.exists()) {
                    dir.mkdirs()
