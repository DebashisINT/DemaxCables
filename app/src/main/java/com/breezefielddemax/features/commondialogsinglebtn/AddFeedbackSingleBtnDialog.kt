package com.breezefielddemax.features.commondialogsinglebtn
...
import com.breezefielddemax.app.domain.ShopVisitCompetetorModelEntity
import com.breezefielddemax.app.domain.VisitRemarksEntity
...
import com.breezefielddemax.features.addshop.presentation.ProspectListDialog
import com.breezefielddemax.features.dashboard.presentation.DashboardActivity
import com.breezefielddemax.features.dashboard.presentation.VisitMultiContactAdapter
...
import com.breezefielddemax.features.nearbyshops.model.ProsListResponseModel
...
//                        mListener.onOkClick(tv_remarks_dropdown.text.toString().trim(), nextVisitDate, filePath,et_approxvalue_name.text.toString(),ProsId)
            ...
            audioRecRoot.id,et_audioNW.id ->{
                ...
                audioFileNW = File("/data/user/0/com.breezefielddemax/files", "recorded_audio${System.currentTimeMillis()}.mp3")
