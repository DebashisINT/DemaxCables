package com.breezefielddemax.features.logoutsync.presentation
...
import com.breezefielddemax.CustomConstants
...
import com.breezefielddemax.base.presentation.BaseActivity.Companion.compositeDisposable
...
import com.breezefielddemax.features.billing.api.AddBillingRepoProvider
import com.breezefielddemax.features.billing.model.AddBillingInputParamsModel
...
import com.breezefielddemax.features.dashboard.presentation.ReasonDialog
...
import com.breezefielddemax.features.document.model.AddEditDocumentInputParams
import com.breezefielddemax.features.document.model.DocumentAttachmentModel
...
import com.breezefielddemax.features.nearbyshops.api.updateaddress.ShopAddressUpdateRepoProvider
import com.breezefielddemax.features.nearbyshops.model.updateaddress.AddressUpdateRequest
import com.breezefielddemax.features.orderhistory.activitiesapi.LocationFetchRepositoryProvider
import com.breezefielddemax.features.orderhistory.api.LocationUpdateRepositoryProviders
import com.breezefielddemax.features.orderhistory.model.*
...
import com.breezefielddemax.features.quotation.model.AddQuotInputModel
import com.breezefielddemax.features.shopdetail.presentation.api.EditShopRepoProvider
import com.breezefielddemax.features.shopdetail.presentation.api.addcollection.AddCollectionRepoProvider
import com.breezefielddemax.features.shopdetail.presentation.model.addcollection.AddCollectionInputParamsModel
...
import com.breezefielddemax.features.stockCompetetorStock.ShopAddCompetetorStockProductList
...
import com.breezefielddemax.features.timesheet.model.AddTimeSheetInputModel
import com.breezefielddemax.features.viewAllOrder.api.addorder.AddOrderRepoProvider
import com.breezefielddemax.features.viewAllOrder.model.AddOrderInputParamsModel
import com.breezefielddemax.features.viewAllOrder.model.AddOrderInputProductList
import com.breezefielddemax.mappackage.SendBrod
import com.breezefielddemax.widgets.AppCustomTextView
import com.breezefielddemax.MonitorService
import com.breezefielddemax.MySingleton
import com.breezefielddemax.app.AlarmReceiver
import com.breezefielddemax.features.addshop.model.*
import com.breezefielddemax.features.addshop.model.assigntopplist.AddShopUploadImg
import com.breezefielddemax.features.addshop.presentation.ShopExtraContactReq
import com.breezefielddemax.features.addshop.presentation.multiContactRequestData
import com.breezefielddemax.features.contacts.CallHisDtls
import com.breezefielddemax.features.dashboard.presentation.model.AudioSyncModel
...
import com.breezefielddemax.features.login.model.GetConcurrentUserResponse
...
import com.breezefielddemax.features.orderITC.SyncDeleteOpptL
import com.breezefielddemax.features.orderITC.SyncEditOppt
import com.breezefielddemax.features.orderITC.SyncOppt
import com.breezefielddemax.features.orderITC.SyncOpptProductL
import com.breezefielddemax.features.orderITC.SyncOrd
import com.breezefielddemax.features.orderITC.SyncOrdProductL
import com.breezefielddemax.features.performance.model.Gps_status_list
import com.breezefielddemax.features.performance.model.UpdateGpsInputListParamsModel
import com.breezefielddemax.features.returnsOrder.ReturnProductList
import com.breezefielddemax.features.returnsOrder.ReturnRequest
import com.breezefielddemax.features.viewAllOrder.model.NewOrderSaveApiModel
import com.breezefielddemax.features.viewAllOrder.model.NewStockSync
                                 ...
                                 doAsync {
                                     ...
                                     uiThread {
                                         ...
                                         try {
                                             ...
                                             var audFile = File("/data/user/0/com.breezefielddemax/files", fileName)
                                             audFile.delete()
                                         }catch (ex:Exception){
                                             ex.printStackTrace()
                                         }
...
//            checkToCallActivity()
    ...
    private fun callLogshareApi(){
        ...
        if(Pref.LogoutWithLogFile){
            try{
                val filesForZip: Array<String> = arrayOf(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefielddemaxlogsample/log").path)
                ZipOutputStream(BufferedOutputStream(FileOutputStream(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefielddemaxlogsample/log.zip").path))).use { out ->
                ...
                val fileUrl = Uri.parse(File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "xbreezefielddemaxlogsample/log.zip").path);
