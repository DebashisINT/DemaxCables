...
import com.breezefielddemax.app.AppConstant.DBNAME
import com.breezefielddemax.app.domain.*
import com.breezefielddemax.features.lead.model.LeadActivityDao
import com.breezefielddemax.features.lead.model.LeadActivityEntity
import com.breezefielddemax.features.location.UserLocationDataDao
import com.breezefielddemax.features.location.UserLocationDataEntity
import com.breezefielddemax.features.login.*
import com.breezefielddemax.features.taskManagement.model.TaskManagementDao
...
@Database(entities = arrayOf(AddShopDBModelEntity::class, UserLocationDataEntity::class, UserLoginDataEntity::class, ShopActivityEntity::class,
    ...
    ShopAudioEntity::class,LMSNotiEntity::class,StockAllEntity::class,StockTransEntity::class,CrashReportEntity::class),
